...
public:
    ...
    static void RecordPlayerDelete(Player* player)
    {
        ...
        if (_deletedPlayerSet.find(player) != _deletedPlayerSet.end())
            LOG_ERROR("server.loading",
                      "!!!!!!Player with id {} already deleted, double deletion!!!",
                      player->GetGUID().GetCounter());

        _deletedPlayerSet.insert(player);
    }
    ...
    static void ValidatePlayerPointer(Player* player)
    {
        ...
        {
            LOG_ERROR("server.loading",
                      "!!!!!!Player with pointer {} already deleted, using dangling pointer!!!",
                      static_cast<void*>(player));

            // Can crash... player already deleted...
            LOG_ERROR("server.loading",
                      "!!!!!!Players guid: {}!!!",
                      player->GetGUID().GetCounter());
        }
...
private:
    ...
    static std::set<Player*> _deletedPlayerSet;
